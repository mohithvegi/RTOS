...
int main(){
    ...
    key = ftok("/home/dell/IMT2015046/8th sem/RTOS/A/ASSIGNMENT-1/EchoEngine/client4", 65);
    ...
    key2 = ftok("/home/dell/IMT2015046/8th sem/RTOS/A/ASSIGNMENT-1/EchoEngine/client4", 66);
    message_id2 = msgget(key2, 0666 | IPC_CREAT);
    msgrcv(message_id2, &message2, sizeof(message2), 4, 0);
